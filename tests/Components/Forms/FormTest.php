...
class FormTest extends ComponentTestCase
{
    ...
    /** @test */
    public function it_renders_html_with_action(): void
    {
        $template = <<<'HTML'
    ...
    /** @test */
    public function it_renders_html_with_method_get(): void
    {
        $template = <<<'HTML'
    ...
    /** @test */
    public function it_renders_html_for_file_uploads(): void
    {
        $template = <<<'HTML'
